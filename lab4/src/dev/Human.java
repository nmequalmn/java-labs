...
public abstract class Human {
    ...
    public void thinkAbout (String about) throws BusyException {
        if(getBusyStatus() == BusyState.BUSY) throw new BusyException();
    ...
    public void setBusyStatus(BusyState status){
